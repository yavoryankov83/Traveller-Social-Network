...
//         $.ajax({
//             type: $GET,
//             url: `${$baseURL}/api/v1/users/filtered?filterParam=${$input.val()}`,
//             dataType: `json`,
...
//         $.ajax({
//             type: $GET,
//             url: `${$baseURL}/api/v1/posts/public/filtered?filterParam=${$input.val()}`,
//             dataType: `json`,
//             contentType: `application/json; charset=UTF-8`,
//             crossDomain: $TRUE,
...
//     $.ajax({
//         type: $GET,
//         url: `${$baseURL}/api/v1/users/pageable?page=${countUserPage}&size=${perPage}`,
//         dataType: `json`,
//         contentType: `application/json; charset=UTF-8`,
//         crossDomain: $TRUE,
//         success: function (users) {
...
//     $.ajax({
//         type: $GET,
//         url: `${$baseURL}/api/v1/posts/public/pageable?page=${countPostPage}&size=${perPage}`,
//         dataType: `json`,
//         contentType: `application/json; charset=UTF-8`,
//         crossDomain: $TRUE,
//         success: function (posts) {
...
//     $.ajax({
//         type: $GET,
//         url: `${$baseURL}/api/v1/posts/users/${userId}/pageable?page=${countPostByUserPage}&size=${perPage}`,
//         dataType: `json`,
//         contentType: `application/json; charset=UTF-8`,
//         crossDomain: $TRUE,
...
//         },
//         error: function () {
//             console.log(`Error loading user posts and comments!`);
//         }
//     });
// };
//
...
//         async: $FALSE,
//         type: $GET,
//         url: `${$baseURL}/api/v1/users/${username}/rolesCount`,
//         dataType: `json`,
//         contentType: `application/json; charset=UTF-8`,
//         crossDomain: $TRUE,
//         success: function (result) {
//             console.log(`Roles count gotten!`);
//             rolesCount = result;
//         },
//         error: function () {
//             console.log(`Error get roles count!`);
//         }
//     });
//     return rolesCount;
// }
...
//             $.ajax({
//                 type: $PUT,
//                 url: `${$baseURL}/api/v1/comments/${parentCommentId}`,
//                 dataType: `json`,
//                 contentType: `application/json; charset=UTF-8`,
//                 crossDomain: $TRUE,
//                 data: JSON.stringify($data),
...
//             $.ajax({
//                 type: $PUT,
//                 url: `${$baseURL}/api/v1/comments/${childCommentId}`,
//                 dataType: `json`,
//                 contentType: `application/json; charset=UTF-8`,
//                 crossDomain: $TRUE,
//                 data: JSON.stringify($data),
...
//                 },
//                 error: function () {
//                     console.log(`Error update reply!`);
...
//     $.ajax({
//         type: $POST,
//         url: `${$baseURL}/api/v1/likedPosts/posts/${postId}`,
//         dataType: `json`,
//         contentType: `application/json; charset=UTF-8`,
//         crossDomain: $TRUE,
//         success: function () {
...
//         },
//         error: function () {
//             console.log(`Error create like of post!`);
//         }
//     });
// });
//
...
//         async: $FALSE,
//         type: $GET,
//         url: `${$baseURL}/api/v1/likedPosts/posts/${postId}/count`,
//         dataType: `json`,
//         contentType: `application/json; charset=UTF-8`,
//         crossDomain: $TRUE,
//         success: function (postLikes) {
//             console.log(`Post likes gotten!`);
//             likesCount = postLikes;
//         },
//         error: function () {
//             console.log(`Error get likes of post!`);
//         }
//     });
...
//             async: $FALSE,
//             type: $POST,
//             url: `${$baseURL}/api/v1/likedComments/${commentId}`,
//             dataType: `json`,
//             contentType: `application/json; charset=UTF-8`,
//             crossDomain: $TRUE,
//             success: function () {
...
//             },
//             error: function () {
//                 console.log(`Error create like of comment!`);
//             }
//         });
...
//         async: $FALSE,
//         type: $GET,
//         url: `${$baseURL}/api/v1/likedComments/comment/${commentId}/count`,
//         dataType: `json`,
//         contentType: `application/json; charset=UTF-8`,
//         crossDomain: $TRUE,
//         success: function (commentLikes) {
//             console.log(`Comment likes gotten!`);
//             commentLikesCount = commentLikes;
//         },
//         error: function () {
//             console.log(`Error get likes of comment!`);
//         }
//     });
...
//             async: $FALSE,
//             type: $POST,
//             url: `${$baseURL}/api/v1/likedComments/${childCommentId}`,
//             dataType: `json`,
//             contentType: `application/json; charset=UTF-8`,
//             crossDomain: $TRUE,
//             success: function () {
...
//             },
//             error: function () {
//                 console.log(`Error create like of reply!`);
//             }
//         });
...
//         async: $FALSE,
//         type: $GET,
//         url: `${$baseURL}/api/v1/likedComments/comment/${childCommentId}/count`,
//         dataType: `json`,
//         contentType: `application/json; charset=UTF-8`,
//         crossDomain: $TRUE,
//         success: function (childCommentLikes) {
//             console.log(`Reply likes gotten!`);
//             childCommentLikesCount = childCommentLikes;
//         },
//         error: function () {
//             console.log(`Error get likes of reply!`);
//         }
//     });
...
//         async: $FALSE,
//         type: $GET,
//         url: `${$baseURL}/api/v1/likedPosts/${postId}/exist`,
//         dataType: `json`,
//         contentType: `application/json; charset=UTF-8`,
//         crossDomain: $TRUE,
//         success: function (result) {
//             console.log(`Like of post exist!`);
//             isExist = result;
//         },
//         error: function () {
//             console.log(`Error like of post existence!`);
//         }
//     });
//     return isExist;
// }
...
//         crossDomain: $TRUE,
//         success: function (postLikes) {
//             console.log(`Likes of post gotten!`);
//             likesCount = postLikes;
//         },
//         error: function () {
//             console.log(`Error get likes of post!`);
...
//         async: $FALSE,
//         type: $GET,
//         url: `${$baseURL}/api/v1/friendShip/friends/user/${userId}`,
//         dataType: `json`,
//         contentType: `application/json; charset=UTF-8`,
//         crossDomain: $TRUE,
//         success: function (result) {
//             console.log(`Friendship exist!`);
//             areFriends = result;
//         },
//         error: function () {
//             console.log(`Error get friendship existence!`);
//         }
//     });
//     return areFriends;
// }
...
//         async: $FALSE,
//         type: $GET,
//         url: `${$baseURL}/api/v1/likedComments/${commentId}/exist`,
//         dataType: `json`,
//         contentType: `application/json; charset=UTF-8`,
//         crossDomain: $TRUE,
//         success: function (result) {
...
//         },
//         error: function () {
//             console.log(`Error get comment like existence!`);
//         }
//     });
//     return isExist;
// }
...
//         },
//         error: function () {
//             console.log(`Error get comment likes!`);
//         }
//     });
...
//         async: $FALSE,
//         type: $GET,
//         url: `${$baseURL}/api/v1/comments/parentComment/post/${postId}`,
//         dataType: `json`,
//         contentType: `application/json; charset=UTF-8`,
//         crossDomain: $TRUE,
...
//         async: $FALSE,
//         type: $GET,
//         url: `${$baseURL}/api/v1/comments/parentComment/post/${postId}/pageable?page=${countCommentPage}&size=${perPage}`,
//         dataType: `json`,
//         contentType: `application/json; charset=UTF-8`,
//         crossDomain: $TRUE,
//         success: function (comments) {
...
//         async: $FALSE,
//         type: $GET,
//         url: `${$baseURL}/api/v1/comments/childComments/comment/${commentId}`,
//         dataType: `json`,
//         contentType: `application/json; charset=UTF-8`,
//         crossDomain: $TRUE,
//         success: function (comments) {
//             console.log(`Replies gotten!`);
//             commentsResultArray = comments;
//         },
//         error: function () {
//             console.log(`Error get replies!`);
//         }
//     });
//     return commentsResultArray;
// }
...
//         },
//         error: function () {
//             console.log(`Error update comment with id: ${commentId}!`);
//             window.location = location.href;
//         }
//     });
// }
...
//     $.ajax({
//         type: $PUT,
//         url: `${$baseURL}/api/v1/comments/${replyId}`,
//         dataType: `json`,
//         contentType: `application/json; charset=UTF-8`,
//         crossDomain: $TRUE,
//         data: JSON.stringify($data),
...
//         },
//         error: function () {
//             console.log(`Error update reply with id: ${replyId}!`);
//             window.location = location.href;
//         }
//     });
// }
...
//     $.ajax({
//         type: $PUT,
//         url: `${$baseURL}/api/v1/comments/${postId}`,
//         dataType: `json`,
//         contentType: `application/json; charset=UTF-8`,
//         crossDomain: $TRUE,
//         data: JSON.stringify($data),
...
//         },
//         error: function () {
//             console.log(`Error update post with id: ${postId}!`);
//             window.location = location.href;
//         }
//     });
// }
//
// //FUNCTIONS TO REQUEST FRIENDSHIP
// function requestFriendship(userRequestId) {
//     $.ajax({
//         async: $FALSE,
//         type: $POST,
//         url: `${$baseURL}/api/v1/friendShip/${userRequestId}`,
//         dataType: `json`,
//         contentType: `application/json; charset=UTF-8`,
//         crossDomain: $TRUE,
//         success: function () {
//             console.log(`Friendship requested by user with id: ${userRequestId}!`);
//             window.location = location.href;
//         },
//         error: function () {
//             console.log(`Error request friendship from user with id: ${userRequestId}!`);
//             window.location = location.href;
//         }
//     })
// }
//
// //FUNCTIONS TO BLOCK FRIENDSHIP
// function blockFriendship(userRequestId) {
//     $.ajax({
//         type: $PUT,
//         url: `${$baseURL}/api/v1/friendShip/${userRequestId}/block`,
//         dataType: `json`,
//         contentType: `application/json; charset=UTF-8`,
//         crossDomain: $TRUE,
//         success: function () {
//             console.log(`Friendship blocked by user with id: ${userRequestId}!`);
//         },
//         error: function () {
//             console.log(`Error block friendship from user with id: ${userRequestId}!`);
//         }
//     })
// }
//
// //FUNCTIONS TO UNBLOCK FRIENDSHIP
// function unblockFriendship(userRequestId) {
//     $.ajax({
//         type: $PUT,
//         url: `${$baseURL}/api/v1/friendShip/${userRequestId}/unblock`,
//         dataType: `json`,
//         contentType: `application/json; charset=UTF-8`,
//         crossDomain: $TRUE,
//         success: function () {
//             console.log(`Friendship unblocked by user with id: ${userRequestId}!`);
//         },
//         error: function () {
//             console.log(`Error unblock friendship from user with id: ${userRequestId}!`);
//         }
//     })
// }
//
// //FUNCTIONS TO REJECT FRIENDSHIP
// function rejectFriendshipRequest(userRequestId) {
//     $.ajax({
//         type: $PUT,
//         url: `${$baseURL}/api/v1/friendShip/${userRequestId}/3`,
//         dataType: `json`,
//         contentType: `application/json; charset=UTF-8`,
//         crossDomain: $TRUE,
//         success: function () {
//             console.log(`Friendship rejected by user with id: ${userRequestId}!`);
//         },
//         error: function () {
//             console.log(`Error reject friendship from user with id: ${userRequestId}!`);
//         }
//     })
// }
//
...
//     $.ajax({
//         type: $PUT,
//         url: `${$baseURL}/api/v1/friendShip/${userRequestId}/2`,
//         dataType: `json`,
//         contentType: `application/json; charset=UTF-8`,
//         crossDomain: $TRUE,
//         success: function () {
//             console.log(`Friendship accepted by user with id: ${userRequestId}!`);
//         },
//         error: function () {
//             console.log(`Error accept friendship from user with id: ${userRequestId}!`);
//         }
//     })
// }
//
...
//         },
//         error: function () {
//             console.log(`Error delete user with id: ${userId}!`);
//         }
//     })
// }
